...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.programs.index') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-100 rounded-full px-4 py-1.5 transition-colors">&larr; Kembali</a>
    <h1 class="text-2xl font-bold text-gray-800 mt-2">Tambah Program</h1>
</div>
    ...
    <form method="POST" action="{{ route('admin.programs.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}"
                   placeholder="Contoh: Baptis Dewasa, Krisma 2026"
